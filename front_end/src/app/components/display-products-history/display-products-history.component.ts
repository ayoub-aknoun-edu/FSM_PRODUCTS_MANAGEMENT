...
@Component({
  selector: 'app-display-products-history',
  templateUrl: './display-products-history.component.html',
  styleUrls: ['./display-products-history.component.css']
})
export class DisplayProductsHistoryComponent {
  ...
  downloadPDF(): void {
    ...
    pdfMake.createPdf(docDefinition as any).download(`product_history_${new Date()}`);
  }
